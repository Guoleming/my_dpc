...
from src.modules.select_backbone import select_resnet
from src.modules.convrnn import ConvGRU
...
class DPC_RNN(nn.Module):
    ...
    def forward(self, block):
        ...
        feature_inf = feature_inf_all[:, N - self.pred_step::, :].contiguous()  # feature_inf is label
        print("feature_inf_all: ", feature_inf_all.shape, "feature_inf: ", feature_inf.shape)
        del feature_inf_all

        print("feature: ", feature.shape, "feature_inf: ", feature_inf.shape)
        ...
        print("pred, feature: ", pred.shape, feature_inf.shape)
